...
-- Requires playerctl
hl.bind("XF86AudioNext", hl.dsp.exec_cmd("playerctl --player=mpd next"), { locked = true })
hl.bind("XF86AudioPause", hl.dsp.exec_cmd("playerctl --player=mpd play-pause"), { locked = true })
hl.bind("XF86AudioPlay", hl.dsp.exec_cmd("playerctl --player=mpd play-pause"), { locked = true })
hl.bind("XF86AudioPrev", hl.dsp.exec_cmd("playerctl --player=mpd previous"), { locked = true })
